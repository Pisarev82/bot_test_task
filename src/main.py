...
from config import BOT_TOKEN, local_run, POSTGRES_URL
from aio_bot.command_handlers import register_handlers
from middleware import ConfigMiddleware, ApiMiddleware, RepositoryMiddleware
from repositories import create_tables
from src.repositories import db
from src.repositories.user_base_repository import engine
